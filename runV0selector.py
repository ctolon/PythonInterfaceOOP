...
class RunV0selector(object):
    ...
    def addArguments(self):
        ...
        # Core Part
        groupCoreSelections = self.parserRunV0selector.add_argument_group(
        ...
        groupTaskAdders = self.parserRunV0selector.add_argument_group(
        ...
        # aod
        groupDPLReader = self.parserRunV0selector.add_argument_group(
        ...
        # automation params
        groupAutomations = self.parserRunV0selector.add_argument_group(
...
if args.add_weakdecay_ind:
    commandToRun += (
        " | o2-analysis-weak-decay-indices --configuration json://" + updatedConfigFileName + " -b"
    )
