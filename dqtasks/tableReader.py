...
class TableReader(object):
    ...
    def addArguments(self):
        ...
        groupAnalysisSelections.add_argument(
            "--analysis",
            help="Skimmed process selections for Data Analysis",
            action="store",
            nargs="*",
            type=str,
            metavar="ANALYSIS",
        ...
        groupProcessSEPSelections = self.parserTableReader.add_argument_group(
        ...
        groupAnalysisEventMixing = self.parserTableReader.add_argument_group(
            title="Data processor options: analysis-event-mixing"
        )
        groupAnalysisEventMixing.add_argument(
            "--mixing",
            help="Skimmed process selections for Event Mixing manually",
            nargs="*",
            action="store",
            type=str,
        ...
        groupAnalysisEventSelection = self.parserTableReader.add_argument_group(
            title="Data processor options: analysis-event-selection"
        )
        groupAnalysisEventSelection.add_argument(
            "--cfgMixingVars",
            help="Mixing configs separated by a space",
            nargs="*",
            action="store",
            type=str,
            metavar="CFGMIXINGVARS",
            choices=allMixing,
        ...
        groupAnalysisMuonSelection = self.parserTableReader.add_argument_group(
        ...
        groupAnalysisTrackSelection = self.parserTableReader.add_argument_group(
        ...
        groupAnalysisDileptonHadron = self.parserTableReader.add_argument_group(
            title="Data processor options: analysis-dilepton-hadron"
        )
