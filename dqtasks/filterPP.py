...
class DQFilterPPTask(object):
    ...
    def addArguments(self):
        ...
        groupProcessFilterPP.add_argument(
            "--process",
            help="DQ Tasks process Selections options",
            action="store",
            type=str,
            nargs="*",
            metavar="PROCESS",
        ...
        # d-q-filter-p-p-task
        groupDQFilterPP = self.parserDQFilterPPTask.add_argument_group(
        ...
        groupDQEventSelection = self.parserDQFilterPPTask.add_argument_group(
            title="Data processor options: d-q-event-selection-task"
        )
        ...
        # d-q-muons-selection
        groupDQMuonsSelection = self.parserDQFilterPPTask.add_argument_group(
            title="Data processor options: d-q-muons-selection"
        )
        groupDQMuonsSelection.add_argument(
            "--cfgMuonsCuts",
            help="Space separated list of muon cuts in d-q muons selection",
            action="store",
            nargs="*",
            type=str,
            metavar="CFGMUONSCUT",
